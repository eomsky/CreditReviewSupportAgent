...
PROBES=[
 ('liquidity_gap','F24','상환재원 및 상환능력',
  ...
  {'available_cash':120-20,'forecast_ocf_after_capex':70-40,'cash_only_maturity_gap':200-((120-20)+(70-40))},
 ...
 ('nonrecurring_margin','F14','수익성',
  ...
  {'reported_margin_2024_pct':90/900*100,'reported_margin_2025_pct':100/1000*100,'adjusted_2025_profit':100-30,'adjusted_2025_margin_pct':(100-30)/1000*100},
 ...
 ('customer_concentration','F10','매출처 및 고객집중도',
  ...
  {'top_two_share_pct':30+25,'customer_a_revenue':1000*.30,'customer_a_gross_profit':1000*.30*.20},
